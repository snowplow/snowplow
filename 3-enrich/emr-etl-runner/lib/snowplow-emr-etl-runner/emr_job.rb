  ...
  module EmrEtlRunner
    class EmrJob
      ...
      def run(config)
        ...
        output_rdb_loader_logs(config[:aws][:emr][:region], config[:aws][:access_key_id], config[:aws][:secret_access_key])
