 ...
 */
class RunInToolSpec extends Specification {

  "A job which is run using Tool.main()" should {

    val Sinks =
      JobSpecHelpers.runJobInTool(RunInToolSpec.lines, "cloudfront", "1", false, List("geo", "domain"))
