...
/**
 * Check that all tuples in a page view in the CloudFront format changed in April 2014 are
 * successfully extracted.
 * For details: https://forums.aws.amazon.com/thread.jspa?threadID=134017&tstart=0#
 */
class Apr2014CfLineSpec extends Specification with EnrichJobSpec {
  import EnrichJobSpec._
  override def appName = "apr-2014-cf-lines"
  sequential
  "A job which processes a CloudFront file containing 1 valid page view" should {
    runEnrichJob(Apr2014CfLineSpec.lines, "cloudfront", "1", false, List("geo"))
