...
class ExtractEventTypeSpec extends Specification with DataTables with ValidationMatchers { def is = s2"""
  ...
  def e3 =
    ...
    "Negative timestamp" !! BCTstamp        ! "Collector timestamp is formatted as [-0030-01-01 00:00:00.000] which isn't Redshift-compatible".fail |
    ">10k timestamp"     !! FarAwayTstamp   ! "Collector timestamp is formatted as [11970-01-01 00:00:00.000] which isn't Redshift-compatible".fail |
