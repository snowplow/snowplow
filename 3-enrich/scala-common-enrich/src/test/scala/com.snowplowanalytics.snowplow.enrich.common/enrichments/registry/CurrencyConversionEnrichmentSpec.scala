...
class CurrencyConversionEnrichmentSpec extends Specification with DataTables { def is =
  ...
  def e2 =
    ...
    "Convert to the same currency"               !! Some("EUR")              ! validAppKey                                 ! Some(11.00)      ! Some(2.67)  ! Some(0.00)  ! Some("EUR")                     ! Some(12.99)                    ! Some(coTstamp)     ! (Some("11.00"),Some("2.67"),Some("0.00"),Some("12.99")).success |
