...
class CurrencyConversionEnrichmentSpec extends Specification with DataTables { def is =
  ...
  val appIdInvalid = Failure(NonEmptyList("Open Exchange Rates error, type: [InvalidAppId], message: [Invalid App ID provided - please sign up at https://openexchangerates.org/signup, or contact support@openexchangerates.org. Thanks!]"))
  ...
  def e2 =
    ...
    "No transaction currency, tax, or shipping"  !! Some("GBP")              ! appId                                 ! Some(11.00)      ! None        ! None        ! None                            ! None                           ! Some(coTstamp)     ! (Some("12.75"),None,None,None).success                     |
    "No transaction currency or total"           !! Some("GBP")              ! appId                                 ! None             ! Some(2.67)  ! Some(0.00)  ! None                            ! None                           ! Some(coTstamp)     ! (None, Some("3.09"), Some("0.00"), None).success           |
    "No transaction currency"                    !! None                     ! appId                                 ! None             ! None        ! None        ! Some("GBP")                     ! Some(12.99)                    ! Some(coTstamp)     ! (None,None,None,Some("15.05")).success                     |
