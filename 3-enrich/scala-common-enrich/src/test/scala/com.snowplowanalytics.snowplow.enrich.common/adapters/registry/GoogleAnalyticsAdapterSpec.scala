...
class GoogleAnalyticsAdapterSpec extends Specification with DataTables with ValidationMatchers with DisjunctionMatchers {
  ...
  def e20 = {
    ...
    val s = Seq(
      ...
      breakDownCompField("pr12id",   "identifier", "IF") must beRightDisjunction(Map("IFpr" -> "12", "prid" -> "identifier")),
      breakDownCompField("pr12cm42", "value",      "IF") must beRightDisjunction(Map("IFprcm" -> "12", "IFcm" -> "42", "prcm" -> "value")),
