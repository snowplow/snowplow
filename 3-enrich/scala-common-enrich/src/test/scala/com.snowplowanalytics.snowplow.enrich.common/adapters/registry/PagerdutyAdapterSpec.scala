...
class PagerdutyAdapterSpec extends Specification with DataTables with ValidationMatchers with ScalaCheck { def is =
  ...
  def e6 = {
    ...
    val expected = NonEmptyList(RawEvent(Shared.api,Map("tv" -> "com.pagerduty-v1", "e" -> "ue", "p" -> "srv", "ue_pr" -> """{"schema":"iglu:com.snowplowanalytics.snowplow/unstruct_event/jsonschema/1-0-0","data":{"schema":"iglu:com.pagerduty/incident/jsonschema/1-0-0","data":{"type":"trigger","data":{"incident":{"id":"P9WY9U9","incident_number":139,"created_on":"2014-11-12T18%3A53%3A47%2B00%3A00","status":"triggered","html_url":"https%3A%2F%2Fsnowplow.pagerduty.com%2Fincidents%2FP9WY9U9","incident_key":"srv01%2FHTTP","service":{"id":"PTHO4FF","name":"Webhooks+Test","html_url":"https%3A%2F%2Fsnowplow.pagerduty.com%2Fservices%2FPTHO4FF","deleted_at":null},"escalation_policy":{"id":"P8ETVHU","name":"Default","deleted_at":null},"assigned_to_user":{"id":"P9L426X","name":"Yali+Sassoon","email":"yali%40snowplowanalytics.com","html_url":"https%3A%2F%2Fsnowplow.pagerduty.com%2Fusers%2FP9L426X"},"trigger_summary_data":{"description":"FAILURE+for+production%2FHTTP+on+machine+srv01.acme.com","client":"Sample+Monitoring+Service","client_url":"https%3A%2F%2Fmonitoring.service.com"},"trigger_details_html_url":"https%3A%2F%2Fsnowplow.pagerduty.com%2Fincidents%2FP9WY9U9%2Flog_entries%2FP5AWPTR","trigger_type":"trigger_svc_event","last_status_change_on":"2014-11-12T18%3A53%3A47Z","last_status_change_by":null,"number_of_escalations":0,"assigned_to":[{"at":"2014-11-12T18%3A53%3A47Z","object":{"id":"P9L426X","name":"Yali+Sassoon","email":"yali%40snowplowanalytics.com","html_url":"https%3A%2F%2Fsnowplow.pagerduty.com%2Fusers%2FP9L426X","type":"user"}}]}},"id":"3c3e8ee0-6a9d-11e4-b3d5-22000ae31361","created_on":"2014-11-12T18%3A53%3A47Z"}}}"""),ContentType.some, Shared.cljSource, Shared.context))
