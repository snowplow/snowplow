...
class ExplodeUriSpec extends Specification with DataTables {
  ...
  def e1 =
    ...
    "Tab & newline in path"   !! "https://snowplowanalytics.com/analytic%0As/index%09nasty.html"                 ! "https"       ! "snowplowanalytics.com" ! 443          ! Some("/analytic%0As/index%09nasty.html")  ! None               ! None            |
