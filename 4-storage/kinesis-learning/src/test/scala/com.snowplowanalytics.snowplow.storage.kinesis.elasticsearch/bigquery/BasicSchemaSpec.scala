...
/**
 * Test the SnowplowEnrichedEventSchema.
 */
class SnowplowEnrichedEventSchemaSpec extends Specification with ValidationMatchers {

  val fields = SnowplowEnrichedEventSchema.fields
  val file = "src/test/resources/example_row"

  "SnowplowEnrichedEventSchema.fields" should {
    "be of length 108" in {
