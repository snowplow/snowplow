...
object Dependencies {
  ...
  object Libraries {
    ...
    val googleApis           = "com.google.apis"            % "google-api-services-bigquery"  % "v2-rev151-1.18.0-rc"
    val googleOauthClient    = "com.google.oauth-client"    % "google-oauth-client"           % "1.18.0-rc"
    val googleHttpClient     = "com.google.http-client"     % "google-http-client-jackson2"   % "1.18.0-rc"
    val googleApiClient      = "com.google.api-client"      %  "google-api-client"        % V.googleApiClient
    val googleJackson        = "com.google.http-client"     % "google-http-client-jackson"  % "1.15.0-rc"
    // Scala
