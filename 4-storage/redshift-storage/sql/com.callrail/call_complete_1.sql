...
CREATE TABLE atomic.com_callrail_call_complete_1 (
	...
	customer_country      varchar(255)   encode runlength,
	customer_name         varchar(255)   encode raw,
	customer_phone_number varchar(255)   encode raw,
	customer_state        varchar(255)   encode text255,
	customer_zip          varchar(255)   encode text32k, 
