...
--
-- Version:     Ports version 0.8.0 to version 0.9.0
-- URL:         -
--
...
ALTER TABLE events RENAME TO events_080;
...
CREATE TABLE atomic.events (
	...
	event_id char(36) not null unique encode lzo,
	...
	geo_region_name varchar(100) encode text32k,
	-- IP lookups
	...
	refr_urlscheme varchar(16) encode bytedict,
	...
	br_viewwidth integer encode lzo,
	...
	dvce_screenwidth integer encode bytedict,
	dvce_screenheight integer encode bytedict,
	-- Document
	doc_charset varchar(128) encode lzo,
	doc_width integer encode lzo,
	doc_height integer encode lzo,
...
INSERT INTO atomic.events (select * from atomic.events_080);
