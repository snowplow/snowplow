...
--
-- Compatibility: iglu:com.mandrill/message_bounced/jsonschema/1-0-0

CREATE TABLE atomic.com_mandrill_message_bounced_1 (
    -- Schema of this type
    ...
    "msg.bgtools_code"       varchar(255)   encode lzo,
    "msg.bounce_description" varchar(255)   encode lzo,
    "msg.diag"               varchar(255)   encode lzo,
    ...
    "msg.template"           varchar        encode lzo,
