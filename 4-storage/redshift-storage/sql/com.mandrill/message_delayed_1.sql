...
--
-- Compatibility: iglu:com.mandrill/message_delayed/jsonschema/1-0-0

CREATE TABLE atomic.com_mandrill_message_delayed_1 (
    -- Schema of this type
    ...
    "msg.tags"             varchar(2048)  encode lzo, -- Holds a JSON array
    "msg.ts"               timestamp      encode lzo,
    "msg.resends"          varchar(2048)  encode lzo, -- Holds a JSON array
