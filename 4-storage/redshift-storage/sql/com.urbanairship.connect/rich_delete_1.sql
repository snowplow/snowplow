...
CREATE TABLE IF NOT EXISTS atomic.com_urbanairship_connect_rich_delete_1 (
...
COMMENT ON TABLE atomic.com_urbanairship_connect_rich_delete_1 IS 'iglu:com.urbanairship.connect/RICH_DELETE/jsonschema/1-0-0';
