...
CREATE TABLE IF NOT EXISTS atomic.com_urbanairship_connect_in_app_message_display_1 (
...
COMMENT ON TABLE atomic.com_urbanairship_connect_in_app_message_display_1 IS 'iglu:com.urbanairship.connect/IN_APP_MESSAGE_DISPLAY/jsonschema/1-0-0';
