...
CREATE TABLE atomic.com_snowplowanalytics_snowplow_ad_click_1 (
	...
	impression_id  varchar(255)   encode lzo,
	zone_id        varchar(255)   encode lzo,
	banner_id      varchar(255)   encode lzo,
	campaign_id    varchar(255)   encode lzo,
	advertiser_id  varchar(255)   encode lzo,
	target_url     varchar(4096)  encode lzo,
	cost_model     char(3)        encode lzo,
	cost           decimal(15,2)	encode lzo,
