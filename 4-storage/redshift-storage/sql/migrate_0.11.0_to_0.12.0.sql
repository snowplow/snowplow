...
CREATE TABLE atomic.events (
	...
	domain_sessionidx int encode AZ64,
	...
	tr_total dec(18,2) encode AZ64,
	tr_tax dec(18,2) encode AZ64,
	tr_shipping dec(18,2) encode AZ64,
	...
	ti_price dec(18,2) encode AZ64,
	ti_quantity int encode AZ64,
	-- Page ping
	pp_xoffset_min int encode AZ64,
	pp_xoffset_max int encode AZ64,
	pp_yoffset_min int encode AZ64,
	pp_yoffset_max int encode AZ64,
	-- User Agent
	...
	br_viewwidth int encode AZ64,
	br_viewheight int encode AZ64,
	-- Operating System
	...
	dvce_screenwidth int encode AZ64,
	dvce_screenheight int encode AZ64,
	-- Document
	doc_charset varchar(128) encode ZSTD,
	doc_width int encode AZ64,
	doc_height int encode AZ64,

	-- Currency
	tr_currency char(3) encode ZSTD,
	tr_total_base dec(18, 2) encode AZ64,
	tr_tax_base dec(18, 2) encode AZ64,
	tr_shipping_base dec(18, 2) encode AZ64,
	ti_currency char(3) encode ZSTD,
	ti_price_base dec(18, 2) encode AZ64,
	...
	-- Time event was sent
	dvce_sent_tstamp timestamp encode AZ64,

	-- Referer
	refr_domain_userid varchar(128) encode ZSTD,
	refr_dvce_tstamp timestamp encode AZ64,

	-- Session ID
	domain_sessionid char(128) encode ZSTD,

	-- Derived timestamp
	derived_tstamp timestamp encode AZ64,
	...
	-- True timestamp
	true_tstamp timestamp encode AZ64,

	CONSTRAINT event_id_0120_pk PRIMARY KEY(event_id)
)
DISTSTYLE KEY
DISTKEY (event_id)
