...
--
-- Compatibility: iglu:com.mailchimp/email_address_change/jsonschema/1-0-0
...
CREATE TABLE atomic.com_mailchimp_email_address_change_1 (
    ...
    "data.new_email"        varchar(255)   encode lzo,
    "data.new_id"           varchar(255)   encode lzo,
    "data.old_email"        varchar(255)   encode lzo,
