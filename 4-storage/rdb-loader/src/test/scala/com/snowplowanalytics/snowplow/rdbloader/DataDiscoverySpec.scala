...
class DataDiscoverySpec extends Specification { def is = s2"""
  ...
  def e2 = {
    ...
    def interpreter: LoaderA ~> TestState = new (LoaderA ~> TestState) {
      ...
      val end = "run=2017-05-22-16-00-57/com.snowplowanalytics.snowplow/geolocation/jsonschema/1-0-0/part-00000" :: second
      ...
      FullDiscovery(
        ...
        Map(
          ...
          ShreddedType(
            ...
            List(
              s3key("s3://runfolder-test/shredded/good/run=2017-05-22-16-00-57/com.snowplowanalytics.snowplow/geolocation/jsonschema/1-0-0/part-00000"),
              s3key("s3://runfolder-test/shredded/good/run=2017-05-22-16-00-57/com.snowplowanalytics.snowplow/geolocation/jsonschema/1-0-0/part-00001"))
        )
      )
    )
