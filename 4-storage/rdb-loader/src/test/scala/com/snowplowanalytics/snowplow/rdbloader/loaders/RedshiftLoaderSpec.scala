...
class RedshiftLoaderSpec extends Specification { def is = s2"""
  ...
  def e1 = {
    ...
    val atomic =
      s"""
        ...
        | CREDENTIALS 'aws_access_key_id=AAAAAAAAAAAAAAAAAAAA;aws_secret_access_key=BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB' REGION AS 'us-east-1'
  ...
  def e4 = {
    ...
    val shredded = List(sql("""
        |COPY atomic.com_snowplowanalytics_snowplow_submit_form_1 FROM 's3://snowplow-acme-storage/shredded/good/run=2017-05-22-12-20-57/shredded-types/com.snowplowanalytics.snowplow/submit_form/jsonschema/1-'
        | CREDENTIALS 'aws_access_key_id=AAAAAAAAAAAAAAAAAAAA;aws_secret_access_key=BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB' JSON AS 's3://snowplow-hosted-assets-us-east-1/4-storage/redshift-storage/jsonpaths/com.snowplowanalytics.snowplow/submit_form_1.json'
        | REGION AS 'us-east-1'
