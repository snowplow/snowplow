...
- view: page_views
  ...
  - dimension: page_view_index
    type: number
    sql: ${TABLE}.page_view_index # index across all sessions
    group_label: 'Page View'

  - dimension: page_view_in_session_index
    type: number
    sql: ${TABLE}.page_view_in_session_index # index within each session
    group_label: 'Page View'
  ...
  - dimension_group: page_view_start_local
    ...
    group_label: 'Page View Time (User Timezone)'
    convert_tz: false
