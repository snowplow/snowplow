...
DROP TABLE IF EXISTS web_user_identity_stitching.users_stich_tmp;
CREATE TABLE web_user_identity_stitching.users_stich_tmp
  ...
  LEFT JOIN scratch_user_identity_stitching.users_rank AS b
