...
class ClientTimestampTest extends Specification {
  ...
  "A SnowPlow row with a client-set timestamp" should {
    ...
    val actual = SnowPlowEventDeserializer.deserializeLine(timestampedRow, DEBUG).asInstanceOf[SnowPlowEventStruct]
