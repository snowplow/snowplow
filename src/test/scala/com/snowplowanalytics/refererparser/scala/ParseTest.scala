...
class ParseTest extends Specification with DataTables { def is =
  ...
  def e1 =
    ...
    "Google search #3"     !! "https://www.google.com/search?sa=t&rct=j&q=g+star&source=web&cd=3&ved=0CEEQFjAA&url=http://www.gstars.co.uk/?ito=GAG5362963510&itc=GAC19854885430&itkw=g-stars&itawnw=search&ei=8eMQUt_hAvTSpgLjqQE&usg=AFQjCNFFNpW7yF9pcqCfOpYvqafYS94p_Q" ! Medium.Search ! Some("Google") ! Some("g star") |
    "Google recursive #1"  !! "https://x.y.z.google.com"                             ! Medium.Search ! Some("Google") ! None |
    "Google recursive #2"  !! "https://w.x.y.z.google.com/search?hl=en&q=Hephaestus" ! Medium.Search ! Some("Google") ! Some("Hephaestus") |
  ...
  def e3 =
    ...
    "Unknown Facebook service"     !! "http://zzz.facebook.com/unknown"       ! Medium.Social    ! Some("Facebook")       ! None           |
